...
final class ExampleEntityController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('example_entity/new.html.twig', [
    ...
    public function edit(Request $request, ExampleEntity $exampleEntity, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('example_entity/edit.html.twig', [
            'example_entity' => $exampleEntity,
            'form' => $form,
        ]);
    }
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$exampleEntity->getId(), $request->getPayload()->getString('_token'))) {
